-- =============================================================================
-- export GEOMETRY NORMALISATION
-- Schema:        export
-- =============================================================================


-- -----------------------------------------------------------------------------
-- export — rename geometry columns, reproject to EPSG:4326, create gist indexes
-- -----------------------------------------------------------------------------
...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE 'index created on geometry column for table % to SRID 4326.', rec.table_name;
    END LOOP;
END $$;